...
class Save {
	...
	function get_chartEditorPreviousFiles():Array<String> {
		if (data.optionsChartEditor.previousFiles == null)
	...
	function get_chartEditorHasBackup():Bool {
		if (data.optionsChartEditor.hasBackup == null)
	...
	function get_chartEditorNoteQuant():Int {
		if (data.optionsChartEditor.noteQuant == null)
	...
	function get_chartEditorDownscroll():Bool {
		if (data.optionsChartEditor.downscroll == null)
	...
	function get_chartEditorPlaytestStartTime():Bool {
		if (data.optionsChartEditor.playtestStartTime == null)
	...
	function get_chartEditorMetronomeVolume():Float {
		if (data.optionsChartEditor.metronomeVolume == null)
	...
	function get_chartEditorHitsoundVolumePlayer():Float {
		if (data.optionsChartEditor.hitsoundVolumePlayer == null)
	...
	function get_chartEditorHitsoundVolumeOpponent():Float {
		if (data.optionsChartEditor.hitsoundVolumeOpponent == null)
	...
	function get_chartEditorThemeMusic():Bool {
		if (data.optionsChartEditor.themeMusic == null)
	...
	function get_chartEditorPlaybackSpeed():Float {
		if (data.optionsChartEditor.playbackSpeed == null)
			data.optionsChartEditor.playbackSpeed = 1.0;
	...
	public function applySongRank(songId:String, difficultyId:String, newScoreData:SaveScoreData):Void {
		...
		if (newScoreData == null || newRank == null)
			return;
